...
| 홈 / 추천 진입                                                               | 질문 플로우                                                                      |
| ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| <img src="./docs/images/readme/home.png" width="220" alt="홈/추천 진입화면"> | <img src="./docs/images/readme/questions.gif" width="220" alt="질문플로우 화면"> |

### 위치 권한 요청 / 위치 설정

<p>
  <img src="./docs/images/readme/location.gif" width="220" alt="위치 권한 요청 화면">
  <img src="./docs/images/readme/location_explore.gif" width="220" alt="위치 권한 요청 화면">
  <img src="./docs/images/readme/location_map.gif" width="220" alt="위치 설정 화면">
</p>

| 추천 결과                                                                             | 주변 탐색                                                                     |
| ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| <img src="./docs/images/readme/recommendations.gif" width="220" alt="추천 결과 화면"> | <img src="./docs/images/readme/explore.gif" width="220" alt="주변 탐색 화면"> |

### 행사 상세 / 관심 행사

<p>
  <img src="./docs/images/readme/event-detail.gif" width="220" alt="행사 상세 화면">
  <img src="./docs/images/readme/favorites.gif" width="220" alt="관심 행사 화면">
</p>
...
<details>
<summary>위치 및 추천 플로우 보기</summary>
...
| 장기 저장 여부 | 사용자 기본 위치나 장기 위치 이력으로 취급하지 않음 |
  ...
  <img src="./docs/images/readme/recommendations-flow.gif" width="220" alt="위치 및 추천플로우">

### 위치 실패 대응 플로우

위치 허용 성공, 권한 거부, timeout, 위치 확인 실패 상황에서도 추천 흐름이 끊기지 않고 수동 위치 설정으로 이어집니다.

  <img src="./docs/images/readme/location-fallback-flow.png" width="600" alt="위치 실패 대응 플로우">
...
<details>
<summary>문서 링크 보기</summary>

| 문서                                                                                                                                     | 설명                                           |
| ---------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| [docs/git-strategy.md](./docs/git-strategy.md)                                                                                           | Git, Issue, Branch, Commit, PR 협업 규칙       |
| [docs/api-convention.md](./docs/api-convention.md)                                                                                       | API 응답, 에러, 인증, 환경변수, Query Key 기준 |
| [Notion PRD](https://full-steam-0ff.notion.site/PRD-v1-4-37d6f75da60e81b9b6d1e005f9ed6055)                                               | 서비스 목적, 사용자 문제, MVP 범위             |
| [Notion 요구사항 정의서](https://full-steam-0ff.notion.site/MUUD-v1-1-PRD-v1-4-3826f75da60e81b5bcadf4a5f602b5ce)                         | 화면/도메인별 기능 요구사항                    |
| [Notion ERD](https://full-steam-0ff.notion.site/ERD-v1-0-v1-0-3826f75da60e8159ac9bf3eb13543dc4)                                          | 데이터 구조 및 관계                            |
| [Notion TDD](https://full-steam-0ff.notion.site/TDD-v1-6-3836f75da60e81b0bcc7c794f872d10e)                                               | 기술 스택, 아키텍처, 구현 기준                 |
| [Notion API 명세서](https://full-steam-0ff.notion.site/587212a1a47a4825ad1d98f8bf6a30de?v=3816f75da60e81f2b9f2000c18422c64)              | 내부 API 요청·응답 기준                        |
| [Notion Troubleshooting Records](https://full-steam-0ff.notion.site/b3fc9cbec3be4e4e874bd570274d6c6e?v=1fb417deffc647be9cc11dddeed93346) | 해결된 문제와 학습 기록                        |
| [Notion Issues DB](https://full-steam-0ff.notion.site/6ca2712f41a34a1b9718652d07a945de?v=cfc7eaa06c9d43bebd7ab1a8bdcee7ac)               | GitHub Issue와 PR 작업 추적                    |
