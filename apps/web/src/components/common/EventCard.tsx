...
export function EventCard({ event, onClick, onLike, shadow = true }: EventCardProps) {
  return (
    <div
      onClick={onClick}
      className={`bg-white rounded-[20px] w-full overflow-hidden cursor-pointer shrink-0 ${shadow ? "shadow-[0px_4px_20px_0px_rgba(63,42,36,0.1)]" : ""}`}
    >
      <div className="relative h-[192px] w-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[rgba(30,20,14,0.45)] to-transparent" />
